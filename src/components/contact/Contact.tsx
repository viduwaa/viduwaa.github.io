...
function Contact() {
    ...
    return (
        <section
            className="text-text py-16 md:p-0 dark flex min-h-[90vh] flex-col items-center justify-center transition-all delay-200 ease-in-out"
            id="contact"
        >
            <div className="container m-auto grid grid-cols-1 md:grid-cols-2">
                <motion.div
                    ...
                    viewport={{ once: true }}
                >
                    <h1 className="mb-[2%] mt-[10%] text-4xl sm:text-5xl transition-all ease-linear text-center">
